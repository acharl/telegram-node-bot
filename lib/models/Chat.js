   ...
   */
   ...
   static deserialize(raw) {
      return new Chat(
          ...
          raw['permissions'] ? ChatPermissions.deserialize(raw['permissions']) : null, 
   ...
   serialize() {
      return { 
          ...
          permissions: this.permissions ? this.permissions.serialize() : undefined, 
